...
public class BloodDonorPhysicalSuitability extends BaseModel {
    ...
    public BloodDonorPhysicalSuitability(Integer donorPhysicalSuitabilityId, Double donorHemoglobin, Double donorWeight, String donorBloodPressure, Double donorPulseRate, Double donorTemperature, String donorBloodGroup, String donorBloodGroupRhesus, PermissionType donorSelection, BloodDonor bloodDonor) {
