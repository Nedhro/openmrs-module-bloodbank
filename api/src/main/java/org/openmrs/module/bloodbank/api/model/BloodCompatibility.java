...
public class BloodCompatibility extends BaseModel {
  ...
  public BloodCompatibility(
      Integer bloodCompatibilityId,
      Compatibility bloodScreening,
      Compatibility bloodGrouping,
      Compatibility bloodCrossMatching,
      Result bloodHivTest,
      Result bloodHbvTest,
      Result bloodHcvTest,
      Result bloodSyphilisTest,
      Result bloodMalariaTest,
      String bloodBagId,
      String patient,
